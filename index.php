        ...
        <div id="tartalom">
            ...
            <div class="scroll">
                <div class="scrollContainer">
                    ...
                    <div id="help">
                    	<h1>Egy kis segítség...</h1>
            
                        <p>Az oldal azzal a céllal jött létre, hogy minél közelebb hozza azokat a megoldásokat az internet, Facebook, Google és az összes többi olyan weboldallal <br>szemben, akik jogosan a tudtunk nélkül használják az adatainkat. </p>
                        <p><em>Na de hogyan működik az alkalmazás?</em></p>
                    </div>
                </div>
            </div>
